...
def get_all_ascii_geotld_ids() -> List[str]:
    """
...
def get_ascii_geotld_by_id(tld: str) -> Optional[Dict[str, Any]]:
    """
...
def get_country_by_id(tld: str) -> Optional[str]:
    """
...
"""if __name__ == "__main__":    
    # Prueba rápida
    print("IDs encontrados:", get_all_ascii_geotld_ids())
    print("Info de 'eus':", get_ascii_geotld_by_id('eus'))
    print("País de 'madrid':", get_country_by_id('madrid'))"""